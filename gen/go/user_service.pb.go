...
type ListUserResponseItem struct {
	...
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Username      string                 `protobuf:"bytes,2,opt,name=username,proto3" json:"username,omitempty"`
	Role          User_Role              `protobuf:"varint,3,opt,name=role,proto3,enum=limestone.User_Role" json:"role,omitempty"` // Referencing the Role enum from the User message
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListUserResponseItem) Reset() {
	*x = ListUserResponseItem{}
...
const file_user_service_proto_rawDesc = "" +
	...
	"\x14ListUserResponseItem\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12(\n" +
	"\x04role\x18\x03 \x01(\x0e2\x14.limestone.User.RoleR\x04role\"\x8e\x01\n" +
	...
	"\x12DeleteUserResponse2\xe4\x04\n" +
	"\vUserService\x12\xb6\x01\n" +
	"\n" +
	"CreateUser\x12\x1c.limestone.CreateUserRequest\x1a\x1f.limestone.StandardUserResponse\"i\xdaARemail,username,password,is_email_verified,first_name,last_name,phone_number,gender\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/users\x12a\n" +
	"\fGetListUsers\x12\x1b.limestone.ListUsersRequest\x1a\x1c.limestone.ListUsersResponse\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/list-users\x12b\n" +
...
var file_user_service_proto_goTypes = []any{
	...
	(*ListUsersRequest)(nil),      // 10: limestone.ListUsersRequest
	(*ListUserResponseItem)(nil),  // 11: limestone.ListUserResponseItem
	(*ListUsersResponse)(nil),     // 12: limestone.ListUsersResponse
	(*GetUserResponse)(nil),       // 13: limestone.GetUserResponse
	(*UpdateUserRequest)(nil),     // 14: limestone.UpdateUserRequest
	(*DeleteUserRequest)(nil),     // 15: limestone.DeleteUserRequest
	(*DeleteUserResponse)(nil),    // 16: limestone.DeleteUserResponse
...
var file_user_service_proto_depIdxs = []int32{
	...
	17, // 3: limestone.User.create_time:type_name -> google.protobuf.Timestamp
	17, // 4: limestone.User.update_time:type_name -> google.protobuf.Timestamp
	...
	16, // 8: limestone.StandardUserResponse.delete_user_response:type_name -> limestone.DeleteUserResponse
	...
	1,  // 11: limestone.ListUserResponseItem.role:type_name -> limestone.User.Role
	11, // 12: limestone.ListUsersResponse.data:type_name -> limestone.ListUserResponseItem
	6,  // 13: limestone.GetUserResponse.user:type_name -> limestone.User
	6,  // 14: limestone.UpdateUserRequest.user:type_name -> limestone.User
	8,  // 15: limestone.UserService.CreateUser:input_type -> limestone.CreateUserRequest
	10, // 16: limestone.UserService.GetListUsers:input_type -> limestone.ListUsersRequest
	9,  // 17: limestone.UserService.GetUser:input_type -> limestone.GetUserRequest
	14, // 18: limestone.UserService.UpdateUser:input_type -> limestone.UpdateUserRequest
	15, // 19: limestone.UserService.DeleteUser:input_type -> limestone.DeleteUserRequest
	7,  // 20: limestone.UserService.CreateUser:output_type -> limestone.StandardUserResponse
	12, // 21: limestone.UserService.GetListUsers:output_type -> limestone.ListUsersResponse
	7,  // 22: limestone.UserService.GetUser:output_type -> limestone.StandardUserResponse
	7,  // 23: limestone.UserService.UpdateUser:output_type -> limestone.StandardUserResponse
	7,  // 24: limestone.UserService.DeleteUser:output_type -> limestone.StandardUserResponse
