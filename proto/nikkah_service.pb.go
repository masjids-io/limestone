...
type Like_Status int32

const (
	Like_STATUS_UNSPECIFIED Like_Status = 0
	// The like is initiated, so the user can see the pictures of the other profile.
	Like_INITIATED Like_Status = 1
	// The like has been completed, indicating mutual interest.
	Like_COMPLETED Like_Status = 2
	// The like has been cancelled.
	Like_CANCELLED Like_Status = 3
)

// Enum value maps for Like_Status.
var (
	Like_Status_name = map[int32]string{
		0: "STATUS_UNSPECIFIED",
		1: "INITIATED",
		2: "COMPLETED",
		3: "CANCELLED",
	}
	Like_Status_value = map[string]int32{
...
func (x Like_Status) Enum() *Like_Status {
	p := new(Like_Status)
	*p = x
	return p
}

func (x Like_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Like_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_nikkah_service_proto_enumTypes[2].Descriptor()
}

func (Like_Status) Type() protoreflect.EnumType {
	return &file_nikkah_service_proto_enumTypes[2]
}

func (x Like_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Like_Status.Descriptor instead.
func (Like_Status) EnumDescriptor() ([]byte, []int) {
...
type Like struct {
	...
	LikerProfileId int32 `protobuf:"varint,2,opt,name=liker_profile_id,json=likerProfileId,proto3" json:"liker_profile_id,omitempty"`
	// The ID of the profile which was liked.
	LikedProfileId int32 `protobuf:"varint,3,opt,name=liked_profile_id,json=likedProfileId,proto3" json:"liked_profile_id,omitempty"`
	// The current status of the like process.
	Status Like_Status `protobuf:"varint,4,opt,name=status,proto3,enum=limestone.Like_Status" json:"status,omitempty"`
	// The create time of the event. This field is output only.
...
func (x *Like) GetLikerProfileId() int32 {
	if x != nil {
...
func (x *Like) GetLikedProfileId() int32 {
	if x != nil {
...
func (x *Like) GetStatus() Like_Status {
	if x != nil {
		return x.Status
	}
	return Like_STATUS_UNSPECIFIED
}
...
type NikkahMatch struct {
	...
	InitiatorProfileId int32 `protobuf:"varint,2,opt,name=initiator_profile_id,json=initiatorProfileId,proto3" json:"initiator_profile_id,omitempty"`
	// The ID of the profile which received the match.
	ReceiverProfileId int32 `protobuf:"varint,3,opt,name=receiver_profile_id,json=receiverProfileId,proto3" json:"receiver_profile_id,omitempty"`
...
func (x *NikkahMatch) GetMatchId() int32 {
	if x != nil {
		return x.MatchId
	}
	return 0
...
func (x *NikkahMatch) GetInitiatorProfileId() int32 {
	if x != nil {
...
func (x *NikkahMatch) GetReceiverProfileId() int32 {
	if x != nil {
...
// InitiateLikeRequest represents a request to initiate a like.
type InitiateLikeRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *InitiateLikeRequest) Reset() {
	*x = InitiateLikeRequest{}
	mi := &file_nikkah_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InitiateLikeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InitiateLikeRequest) ProtoMessage() {}

func (x *InitiateLikeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_nikkah_service_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InitiateLikeRequest.ProtoReflect.Descriptor instead.
func (*InitiateLikeRequest) Descriptor() ([]byte, []int) {
	return file_nikkah_service_proto_rawDescGZIP(), []int{9}
}

func (x *InitiateLikeRequest) GetLike() *Like {
	if x != nil {
		return x.Like
	}
	return nil
...
// CancelLikeRequest represents a request to cancel a like.
...
func (x *CancelLikeRequest) GetLikeId() int32 {
	if x != nil {
		return x.LikeId
	}
	return 0
...
// CompleteLikeRequest represents a request to complete a like.
type CompleteLikeRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *CompleteLikeRequest) Reset() {
	*x = CompleteLikeRequest{}
	mi := &file_nikkah_service_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CompleteLikeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompleteLikeRequest) ProtoMessage() {}

func (x *CompleteLikeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_nikkah_service_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompleteLikeRequest.ProtoReflect.Descriptor instead.
func (*CompleteLikeRequest) Descriptor() ([]byte, []int) {
	return file_nikkah_service_proto_rawDescGZIP(), []int{11}
}

func (x *CompleteLikeRequest) GetLikeId() int32 {
	if x != nil {
		return x.LikeId
	}
	return 0
...
// CompleteLikeResponse represents a response to a complete like request.
type CompleteLikeResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *CompleteLikeResponse) Reset() {
	*x = CompleteLikeResponse{}
	mi := &file_nikkah_service_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CompleteLikeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CompleteLikeResponse) ProtoMessage() {}

func (x *CompleteLikeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_nikkah_service_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CompleteLikeResponse.ProtoReflect.Descriptor instead.
func (*CompleteLikeResponse) Descriptor() ([]byte, []int) {
	return file_nikkah_service_proto_rawDescGZIP(), []int{12}
}

func (x *CompleteLikeResponse) GetLike() *Like {
	if x != nil {
		return x.Like
	}
	return nil
...
func (x *CompleteLikeResponse) GetMatch() *NikkahMatch {
	if x != nil {
		return x.Match
	}
	return nil
...
func (x *AcceptNikkahMatchInviteRequest) GetMatchId() int32 {
	if x != nil {
		return x.MatchId
	}
	return 0
...
func (x *RejectNikkahMatchInviteRequest) GetMatchId() int32 {
	if x != nil {
		return x.MatchId
	}
	return 0
...
func (x *EndNikkahMatchRequest) GetMatchId() int32 {
	if x != nil {
		return x.MatchId
	}
	return 0
...
var file_nikkah_service_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x05, 0x0a, 0x0d, 0x4e,
	0x69, 0x6b, 0x6b, 0x61, 0x68, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x0e, 0x0a, 0x02,
	...
	,
	...
	,
	...
	,
	...
	0x6d, 0x70, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x4d,
	...
	,
	...
	0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x56, 0x0a, 0x06, 0x53,
	...
	,
	...
	0x7a, 0x0a, 0x1a, 0x4c, 0x69, 0x73, 0x74, 0x4e, 0x69, 0x6b, 0x6b, 0x61, 0x68, 0x50, 0x72, 0x6f,
	0x66, 0x69, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a,
	...
	0x61, 0x68, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x66, 0x69,
	0x6c, 0x65, 0x73, 0x12, 0x26, 0x0a, 0x0f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x70, 0x61, 0x67, 0x65,
	0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6e, 0x65,
	0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x38, 0x0a, 0x17, 0x47,
	0x65, 0x74, 0x4e, 0x69, 0x6b, 0x6b, 0x61, 0x68, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x52,
	...
	,
	...
	,
...
var file_nikkah_service_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_nikkah_service_proto_goTypes = []any{
	...
	(*InitiateLikeRequest)(nil),            // 13: limestone.InitiateLikeRequest
	(*CancelLikeRequest)(nil),              // 14: limestone.CancelLikeRequest
	(*CompleteLikeRequest)(nil),            // 15: limestone.CompleteLikeRequest
	(*CompleteLikeResponse)(nil),           // 16: limestone.CompleteLikeResponse
	(*AcceptNikkahMatchInviteRequest)(nil), // 17: limestone.AcceptNikkahMatchInviteRequest
	(*RejectNikkahMatchInviteRequest)(nil), // 18: limestone.RejectNikkahMatchInviteRequest
	(*EndNikkahMatchRequest)(nil),          // 19: limestone.EndNikkahMatchRequest
	(*NikkahProfile_BirthDate)(nil),        // 20: limestone.NikkahProfile.BirthDate
...
var file_nikkah_service_proto_depIdxs = []int32{
	...
	20, // 1: limestone.NikkahProfile.birth_date:type_name -> limestone.NikkahProfile.BirthDate
	21, // 2: limestone.NikkahProfile.create_time:type_name -> google.protobuf.Timestamp
	21, // 3: limestone.NikkahProfile.update_time:type_name -> google.protobuf.Timestamp
	2,  // 4: limestone.Like.status:type_name -> limestone.Like.Status
	21, // 5: limestone.Like.create_time:type_name -> google.protobuf.Timestamp
	21, // 6: limestone.Like.update_time:type_name -> google.protobuf.Timestamp
	3,  // 7: limestone.NikkahMatch.status:type_name -> limestone.NikkahMatch.Status
	21, // 8: limestone.NikkahMatch.create_time:type_name -> google.protobuf.Timestamp
	21, // 9: limestone.NikkahMatch.update_time:type_name -> google.protobuf.Timestamp
	...
	5,  // 13: limestone.InitiateLikeRequest.like:type_name -> limestone.Like
	5,  // 14: limestone.CompleteLikeResponse.like:type_name -> limestone.Like
	6,  // 15: limestone.CompleteLikeResponse.match:type_name -> limestone.NikkahMatch
	...
	13, // 22: limestone.NikkahIoService.InitiateLike:input_type -> limestone.InitiateLikeRequest
	14, // 23: limestone.NikkahIoService.CancelLike:input_type -> limestone.CancelLikeRequest
	15, // 24: limestone.NikkahIoService.CompleteLike:input_type -> limestone.CompleteLikeRequest
	17, // 25: limestone.NikkahIoService.AcceptNikkahMatchInvite:input_type -> limestone.AcceptNikkahMatchInviteRequest
	18, // 26: limestone.NikkahIoService.RejectNikkahMatchInvite:input_type -> limestone.RejectNikkahMatchInviteRequest
	19, // 27: limestone.NikkahIoService.EndNikkahMatch:input_type -> limestone.EndNikkahMatchRequest
	4,  // 28: limestone.NikkahIoService.CreateNikkahProfile:output_type -> limestone.NikkahProfile
	4,  // 29: limestone.NikkahIoService.GetSelfNikkahProfile:output_type -> limestone.NikkahProfile
	4,  // 30: limestone.NikkahIoService.UpdateSelfNikkahProfile:output_type -> limestone.NikkahProfile
	11, // 31: limestone.NikkahIoService.ListNikkahProfiles:output_type -> limestone.ListNikkahProfilesResponse
	4,  // 32: limestone.NikkahIoService.GetNikkahProfile:output_type -> limestone.NikkahProfile
	5,  // 33: limestone.NikkahIoService.InitiateLike:output_type -> limestone.Like
	5,  // 34: limestone.NikkahIoService.CancelLike:output_type -> limestone.Like
	16, // 35: limestone.NikkahIoService.CompleteLike:output_type -> limestone.CompleteLikeResponse
	6,  // 36: limestone.NikkahIoService.AcceptNikkahMatchInvite:output_type -> limestone.NikkahMatch
	6,  // 37: limestone.NikkahIoService.RejectNikkahMatchInvite:output_type -> limestone.NikkahMatch
	6,  // 38: limestone.NikkahIoService.EndNikkahMatch:output_type -> limestone.NikkahMatch
